...
1) python code file.ipynb include the python code file for the data analysis.
2) Credit Risk Analysis Case Study ppt.pdf provides summary of the data analysis.
